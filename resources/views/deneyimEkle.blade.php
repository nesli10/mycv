                    ...
                    <div class="col-md-10 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"style="background: lightgrey">
                                ...
                                <div class="form-group">
                                    <label for="calismayeri">Çalışma Yeri</label>
                                    <input type="text" class="form-control" name="calismayeri" id="calismayeri" placeholder="Çalışma Yeri" value="{{ isset($guncelle->calismayeri) ? $guncelle->calismayeri : ""}}">
                                </div>
                                <div class="form-group" >
...
<script >
    $(document).ready(function(){
        ...
        $('#kaydet').on('click', function(){
            ...
            let errorMsg = "";
            if(data.pozisyon == "") errorMsg += "- pozisyon alanı boş bırakılamaz.<br>";
            if(data.calismayeri == "") errorMsg += "- çalışma yeri alanı boş bırakılamaz.<br>";
